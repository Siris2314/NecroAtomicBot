  ...
  run: async (client, interaction) => {
    ...
    if (
      ...
      return interaction.followUp({
        content: "You cannot do this action due to having lower role hierarchy",
      });
    ...
    const sendEmbed = new MessageEmbed()
      ...
      .setDescription(
        `You have been warned by ${interaction.username} for ${reason}`
      );
    ...
    interaction.followUp({
      embeds: [
        new MessageEmbed()
          ...
          .setDescription(
            `${member.user.username} has been by ${interaction.user.username} for \n${reason}`
          )
          .setColor(),
      ],
    });
